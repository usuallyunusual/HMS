 ...
 * @author vigne
 */
public class frontDeskAppointment extends javax.swing.JFrame {
    String username,date,time,id;

    /**
     * Creates new form frontDeskAppointment
     */
    public frontDeskAppointment() {
        initComponents();
    }
    public frontDeskAppointment(String username,String date,String time) {
    ...
    private void initComponents() {
        ...
        dateapp = new com.github.lgooddatepicker.components.DatePicker();
        timeapp = new com.github.lgooddatepicker.components.TimePicker();
        ...
        makeapp1 = new javax.swing.JButton();
        ...
        doc.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Doc ID", "Name", "Sex", "License Number", "Specialization", "Consulting Price"
            }
        ) {
            Class[] types = new Class [] {
        ...
        jScrollPane5.setViewportView(doc);

        jTabbedPane1.addTab("Doctors", jScrollPane5);
        ...
        makeapp.setText("Make Appointment");
        ...
        makeapp1.setText("Cancel Appointment");
        makeapp1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                makeapp1ActionPerformed(evt);
            }
        });
        ...
        genbill.setText("Generate Bill Amount");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(docid, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(makeapp1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(makeappp, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(makeapp1, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(makeappp, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addComponent(genbill, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
    ...
    private void makeappActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_makeappActionPerformed
      ...
      String doc=docid.getText();
      String datea=dateapp.getDate().toString();
      int flag=0;
      ...
      date1.setHours(timeapp.getTime().getHour());
date1.setMinutes(timeapp.getTime().getMinute());
date1.setSeconds(timeapp.getTime().getSecond());
String timea=sdfo.format(date1);
      jTabbedPane1.setSelectedIndex(0);
        for (int row = 0; row <= appointments.getRowCount() - 1; row++) {
          //  System.out.println((datea.equals(row+" "+appointments.getValueAt(row, 4))));
            ...
            //  System.out.println((doc.equals(appointments.getValueAt(row, 2))));
                    ...
                    if ( ((datea.equals(appointments.getValueAt(row, 4)))&& (timea.equals(appointments.getValueAt(row,5))) && (doc.equals(appointments.getValueAt(row,2)))) || (dateapp.getDate().isBefore(today)) || ((timeapp.getTime().isBefore(d2)) && (dateapp.getDate().isBefore(today)) )  ) 
                    {
        ...
        try {
            ...
            String query="SELECT * FROM DOC_INFO WHERE DOC_ID='"+doc+"'";
            ResultSet rs=st.executeQuery(query);
            String cprice="0";
            while(rs.next())
            {
                     cprice=rs.getString("consulting_price");
            }
            // JOptionPane.showMessageDialog(null, "price"+cprice , "Update", 2);
            ...
            else
            {
                ...
                int k=Integer.parseInt(j.substring(2));
                i++;
                k++;
                id="A"+i;
                j="Di"+k;
            }
            String qt="INSERT INTO APPOINTMENTS VALUES('"+id+"','"+patient+"','"+doc+"','"+username+"','"+datea+"','"+timea+"','0','0','"+j+"','"+cprice+"','0','0')";
            st.executeUpdate(qt);
    ...
    private void addpatientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addpatientActionPerformed
        new AddPatient(username,date,time).setVisible(true);
        this.dispose();
   ...
   public void updateTables()
{
     DefaultTableModel model = (DefaultTableModel)
        ...
        try {
            ...
            con=DriverManager.getConnection(connectString,"root","");
             Statement st=con.createStatement();
             String qr="SELECT * FROM APPOINTMENTS WHERE CANCELLED ='1'";
               ResultSet rs = st.executeQuery( qr );
               String temp="";
               Statement s=con.createStatement();
               while(rs.next())
               {
                   temp=rs.getString("appointment_id");
                   qr="DELETE FROM APPOINTMENT_ROOM WHERE APPOINTMENT_ID='"+temp+"'";
                   s.executeUpdate(qr);
                    qr="DELETE FROM APPOINTMENT_OPERATION WHERE APPOINTMENT_ID='"+temp+"'";
                   s.executeUpdate(qr);
               }
               
              qr="SELECT * FROM DOC_INFO WHERE EMPLOYED = '1'";
               rs = st.executeQuery( qr );
                while(rs.next())
                {
                   ...
                   // String m=rs.getString("employed");
                    model4.addRow(new Object[]{ a, b, d, e, h, k,});
                }
                ...
                String q4="SELECT * FROM APPOINTMENTS WHERE CANCELLED = '0'";
                ...
                while(rs.next())
                {
                    ...
                    model.addRow(new Object[]{ a, b, c, d, e, f, g,h,i,j,k,i});
                      ...
                      String q12="SELECT * FROM APPOINTMENTS";
                ...
                while(rs.next())
                {
                 ...
                 String q="SELECT * FROM APPOINTMENTS WHERE CANCELLED = '1'";
    ...
    private void searchdocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchdocActionPerformed
       ...
       jTabbedPane1.setSelectedIndex(5);
        for (int row = 0; row <= doc.getRowCount() - 1; row++) {

                for (int col = 0; col <= doc.getColumnCount() - 1; col++) {

                    if (searchStr.equals(doc.getValueAt(row, col))) {

                        // this will automatically set the view of the scroll in the location of the value
                        doc.scrollRectToVisible(doc.getCellRect(row, 0, true));
                        docid.setText(doc.getValueAt(row, 0).toString());

                        // this will automatically set the focus of the searched/selected row/value
                        doc.setRowSelectionInterval(row, row);

                        for (int i = 0; i <= doc.getColumnCount() - 1; i++) {

                            doc.getColumnModel().getColumn(i).setCellRenderer(new HighlightRenderer());
                        }
                    }
                }
            }
    ...
    private void makeapp1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_makeapp1ActionPerformed
        int index=jTabbedPane1.getSelectedIndex();
        if(index==0)
        {
    ...
    }//GEN-LAST:event_makeapp1ActionPerformed
    ...
    private void genbillActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_genbillActionPerformed
        ...
        if((patientid.getText()!=null))
                ...
                try {
                    ...
                    con=DriverManager.getConnection(connectString,"root","");
                    Statement st=con.createStatement();
                    String query="SELECT * FROM APPOINTMENTS WHERE PATIENT_ID='"+patientid.getText()+"' AND PAID='0' AND CANCELLED ='0'";
                    ResultSet rs=st.executeQuery(query);
                    int price=0;
                    String aid="";
                    int count=0;
                    while(rs.next())
                    {
                        price=price+Integer.parseInt(rs.getString("consulting_price"));
                        aid=rs.getString("appointment_id");
                        count++;
                    }
                     new Bill(patientid.getText(),aid,price,count).setVisible(true);
                 //  docid.setText(""+price);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frontDeskAppointment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frontDeskAppointment().setVisible(true);
            }
        });
    }
    ...
    private com.github.lgooddatepicker.components.DatePicker dateapp;
    ...
    private javax.swing.JButton makeapp1;
    ...
    private com.github.lgooddatepicker.components.TimePicker timeapp;
